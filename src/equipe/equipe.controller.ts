import { Controller, NotFoundException, ForbiddenException, NotAcceptableException, ConflictException } from "@nestjs/common";
import { Post, Get, Patch, Param, Delete, Body, UseGuards } from "@nestjs/common";
...
export class EquipeController{
    ...
    async createEquipe(@Body() createEquipeDTO: CreateEquipeDto): Promise<Equipe>{
    ...
    @Patch('/update/:id')
    @UseGuards(JwtAuthGuard)
    async updateEquipe(@Param('id') id: string, @Body() updateEquipeDTO: UpdateEquipeDto): Promise<Equipe> {
