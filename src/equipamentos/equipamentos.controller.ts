...
export class EquipamentosController{
    ...
    async createEquipamento(@Body() createEquipamentoDto: CreateEquipamentoDto): Promise<Equipamentos>{
    ...
    @Patch('edit/:id')
    @UseGuards(JwtAuthGuard)
    async updateEquipamento(@Param('id') id: string, @Body() updateEquipamentoDto: any): Promise<Equipamentos>{
